(function($) {
    ...
    stepFormWizard.prototype.init = function() {
        ...
        $(widget.element).on('click', '.next-btn', function(e) {
            if(widget.config.onNext(widget.stepActive, widget.wizard) !== false) {
                widget.goTo($('.sf-controls .next-btn', widget.element).data('step'));
            }
            e.preventDefault();
        })

        $(widget.element).on('click', '.prev-btn', function(e) {
            if(widget.config.onPrev(widget.stepActive, widget.wizard) !== false) {
                widget.goTo($('.sf-controls .prev-btn', widget.element).data('step'));
            }
            e.preventDefault();
        })

        $(widget.element).on('click', '.finish-btn', function(e) {
